    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden py-20 md:py-32 lg:py-40">
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <p className="mx-auto max-w-[700px] text-lg md:text-xl text-muted-foreground mb-10">
              Stop losing students to Discord distractions. Provide a focused, private environment designed specifically for team formation, project collaboration, and live cohort management.
            </p>
        ...
        <section id="features" className="py-20 bg-muted/30">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Built for Course Creators</h2>
              <p className="text-muted-foreground text-lg max-w-[600px] mx-auto">
                Everything you need to manage your community and help them succeed, without the noise.
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-2xl font-semibold mb-10 text-muted-foreground">Trusted by forward-thinking educators</h2>
            <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
              {/* Placeholders for logos */}
              <div className="flex items-center gap-2 text-xl font-bold"><div className="h-8 w-8 bg-foreground rounded-full"></div>DevCohort</div>
              <div className="flex items-center gap-2 text-xl font-bold"><div className="h-8 w-8 bg-foreground rounded-full"></div>CodeCamp</div>
              <div className="flex items-center gap-2 text-xl font-bold"><div className="h-8 w-8 bg-foreground rounded-full"></div>DesignSchool</div>
              <div className="flex items-center gap-2 text-xl font-bold"><div className="h-8 w-8 bg-foreground rounded-full"></div>TechMBA</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to upgrade your community?</h2>
            <p className="text-primary-foreground/80 text-xl max-w-[600px] mx-auto mb-10">
              Join hundreds of course creators who have switched from Discord to TeamBuilder.
            </p>
            <Link href="/register">
              <Button size="lg" variant="secondary" className="h-14 px-10 text-lg font-semibold shadow-lg hover:shadow-xl transition-all">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-muted-foreground text-sm">
                The dedicated platform for cohort-based courses and community building.
              </p>
            </div>
            <div>
